      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
          <a
            ...
            className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white p-4 rounded-full shadow-2xl hover:shadow-3xl hover:scale-110 transition-all duration-300 flex items-center justify-center group animate-bounce hover:animate-none"
            title="WhatsApp us"
          >
            ...
            <span className="ml-2 hidden group-hover:inline-block text-sm font-bold whitespace-nowrap">WhatsApp</span>
          </a>
          <a
